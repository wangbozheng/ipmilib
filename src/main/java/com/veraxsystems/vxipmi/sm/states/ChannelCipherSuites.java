 ...
 */
public class ChannelCipherSuites extends State {
	...
	public void doTransition(StateMachine stateMachine,
		...
		if (machineEvent instanceof GetChannelCipherSuitesPending) {
			...
			com.veraxsystems.vxipmi.coding.commands.session.GetChannelCipherSuites cipherSuites = new com.veraxsystems.vxipmi.coding.commands.session.GetChannelCipherSuites(
